...
namespace DB.Migrations
{
    ...
    [Migration("20250222083705_communitytable1")]
    partial class communitytable1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB.Model.CommunityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DB.Model.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DB.EFModel.Community", b =>
                {
                    b.HasOne("DB.Model.CommunityType", "CommunityType")
                        .WithMany()
                        .HasForeignKey("CommunityTypeId");

                    b.HasOne("DB.Model.State", "State")
                        .WithMany()
